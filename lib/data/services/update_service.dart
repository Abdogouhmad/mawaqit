/// OTA update service: fetches `update_manifest.json` from this repo and
/// compares it against the installed version.
///
...
/// the CI workflow that writes it.
const String kGitHubRepo = 'Abdogouhmad/mawaqit';
